...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_user_youtube_playlist", "playlists", ["user_id", "youtube_id"], unique=True
    )
    ...
    op.create_index(
        "idx_user_categorized", "videos", ["user_id", "is_categorized"], unique=False
    )
    op.create_index(
        "idx_user_youtube_id", "videos", ["user_id", "youtube_id"], unique=True
    )
