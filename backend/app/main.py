...
async def lifespan(app: FastAPI):
    ...
    # Run database migrations on startup (skip in production serverless to avoid race conditions)
    if not settings.is_production:
        ...
        db_logger.info("Skipping auto-migrations in production (run manually)")
