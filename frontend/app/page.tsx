...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen">
          ...
          <CardBody className="p-10">
            <div className="space-y-8">
              ...
              <div className="text-center space-y-2">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-linear-to-br from-blue-600 to-purple-600 rounded-2xl">
                    <SmartDisplayIcon className="text-white" sx={{ fontSize: 40 }} />
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <Button
                  size="lg"
                  className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all"
                  onPress={handleLogin}
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 lg:p-16 text-white w-full">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-white/90 max-w-lg">
              Automatically categorize, tag, and organize your liked videos and playlists with the power of artificial intelligence.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 gap-4">
              <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20 hover:bg-white/20 transition-all">
                ...
                <div>
                  <p className="font-semibold text-lg">AI-Powered Categorization</p>
                  <p className="text-white/80 text-sm">Smart categorization using GPT-4</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20 hover:bg-white/20 transition-all">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Intelligent tags and categories</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20 hover:bg-white/20 transition-all">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Find any video instantly</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20 hover:bg-white/20 transition-all">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Track your viewing patterns</p>
                </div>
              </div>
            </div>
          </div>
