        ...
        <div className="space-y-6">
            ...
            <div>
              ...
              {user?.last_sync_at && (
                <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">
                  Last synced: {formatDistanceToNow(new Date(user.last_sync_at), { addSuffix: true })}
                </p>
              )}
            </div>
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Fetching your liked videos from YouTube and categorizing them with AI.
                    </p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          >
            <ModalContent>
              ...
              <ModalBody className="py-8">
                {batchSyncing ? (
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-center space-y-2">
                      <p className="text-lg font-semibold">Syncing all your liked videos...</p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        This will fetch all your liked videos from YouTube without limit.
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        For 1000+ videos, this may take 5-10 minutes. Please be patient.
                      </p>
                  ...
                  <div className="space-y-4">
                    <div className="text-center">
                      ...
                      <p className="text-lg font-semibold mb-2">{batchSyncResult.message}</p>
                    </div>
                    <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Total Videos Synced:</span>
                        <span className="font-semibold">{batchSyncResult.total_videos_synced}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Pages Fetched:</span>
                        <span className="font-semibold">{batchSyncResult.pages_fetched}</span>
                      </div>
                      {batchSyncResult.videos_categorized > 0 && (
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">Videos Categorized:</span>
                          <span className="font-semibold">{batchSyncResult.videos_categorized}</span>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              {batchSyncResult && (
                <ModalFooter>
                  <Button color="primary" onPress={() => setBatchSyncResult(null)}>
                    Close
                  </Button>
                </ModalFooter>
              )}
          ...
          >
            <ModalContent>
              <ModalHeader className="flex flex-col gap-1">
                {batchCategorizing ? "Categorizing Videos" : "Categorization Complete"}
              </ModalHeader>
              <ModalBody className="py-8">
                {batchCategorizing ? (
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-center space-y-2">
                      <p className="text-lg font-semibold">Categorizing all uncategorized videos...</p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Processing videos in parallel batches of 10 for maximum efficiency.
                      </p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        This may take several minutes for large numbers of videos.
                      </p>
                      <p className="text-xs text-gray-500 dark:text-gray-500 mt-4">
                        You can check the browser console for progress updates.
                      </p>
                  ...
                  <div className="space-y-4">
                    <div className="text-center">
                      ...
                      <p className="text-lg font-semibold mb-2">{categorizationResult.message}</p>
                    </div>
                    <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Total Videos:</span>
                        <span className="font-semibold">{categorizationResult.total_videos}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-green-600 dark:text-green-400">Categorized:</span>
                      ...
                      <div className="flex justify-between pt-2 border-t border-gray-300 dark:border-gray-600">
                        ...
                        <span className="font-semibold">{categorizationResult.success_rate}%</span>
                      </div>
                    </div>
                  </div>
                ) : null}
              ...
              {categorizationResult && (
                <ModalFooter>
                  <Button color="primary" onPress={() => setCategorizationResult(null)}>
                    Close
                  </Button>
                </ModalFooter>
              )}
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="bg-linear-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-none shadow-lg">
                  <CardBody className="p-6">
                    <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Categorized</h3>
                ...
                <Card className="bg-linear-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border-none shadow-lg">
                  <CardBody className="p-6">
                    <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Uncategorized</h3>
              ...
              <Card className="shadow-lg">
                <CardHeader className="pb-3">
                  <h3 className="text-lg font-semibold">Categorization Progress</h3>
                </CardHeader>
                <CardBody className="pt-4">
                  ...
                  />
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    {stats.categorized} of {stats.total_videos} videos categorized
                  </p>
                </CardBody>
              </Card>
                      ...
                      <div className="space-y-3">
                        {stats.top_categories.map((category, index) => (
                          <div key={index} className="flex justify-between items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <Chip color="primary" variant="flat" size="sm" radius="md">
                              {category.count}
                            </Chip>
                          </div>
                        ))}
                    ...
                    {stats.top_tags.length > 0 ? (
                      <div className="flex flex-wrap gap-2">
                        {stats.top_tags.map((tag, index) => (
                          <Chip key={index} variant="bordered" size="sm" radius="md">
                            {tag.name} ({tag.count})
                          </Chip>
                        ))}
                      </div>
